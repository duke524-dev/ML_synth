"""
Data manager for 1-minute and 5-minute OHLC storage with resampling
"""
import logging
...
class DataManager:
    """Manages 1-minute and 5-minute OHLC data with resampling"""
    
    def __init__(self, asset: str):
        self.asset = asset
        # Re-entrant because some getters call other getters that also lock.
