...
Similar to LGBM-miner state_updater.py
"""
import logging
import time
import signal
...
from config import (
    TOKEN_MAP, WARMUP_1M_HOURS, WARMUP_5M_DAYS,
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Fixed Hybrid Miner State Updater")
    ...
    parser.add_argument("--warmup-date", type=str, default=None, 
                        help="Target date for warmup (YYYY-MM-DD)")
